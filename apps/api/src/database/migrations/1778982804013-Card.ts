...
export class Card1778982804013 implements MigrationInterface {
    name = 'Card1778982804013'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "payment" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "cardNumber" character varying(4) NOT NULL, "holderName" character varying(50) NOT NULL, "expires" character varying(7) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`);
