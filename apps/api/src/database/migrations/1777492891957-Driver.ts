...
export class Driver1777492891957 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."drivers_vehicletype_enum" AS ENUM('car', 'motorcycle')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."drivers_status_enum" AS ENUM('available', 'busy', 'offline')`,
    );
    await queryRunner.query(
      `CREATE TABLE "drivers" ("id" integer NOT NULL, "RUT" character varying(12) NOT NULL, "identityDocument" text NOT NULL, "drivingLicense" text NOT NULL, "vehicleType" "public"."drivers_vehicletype_enum" NOT NULL, "plateNumber" character varying(15), "status" "public"."drivers_status_enum" NOT NULL, "isVerified" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_92ab3fb69e566d3eb0cae896047" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "drivers" ADD CONSTRAINT "FK_92ab3fb69e566d3eb0cae896047" FOREIGN KEY ("id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "drivers" DROP CONSTRAINT "FK_92ab3fb69e566d3eb0cae896047"`,
    );
