...
export class AddProofToOrder1779069000804 implements MigrationInterface {
    name = 'AddProofToOrder1779069000804'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "driverId" integer, "restaurantId" integer NOT NULL, "status" "public"."orders_status_enum" NOT NULL DEFAULT 'pending', "shippingAddress" text NOT NULL, "notes" text, "totalPrice" integer NOT NULL, "proofOfDelivery" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
